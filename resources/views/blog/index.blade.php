    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          {{-- <div class="card-header"> 
            ...
            <a href="{{route('blog.trashed')}}">Trashed blogs</a>
          </div>
          <br> --}}
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a  class="text-success" href="{{route('blog.show',['id'=> $blog->id])}}"> <i class="fas  fa-2x fa-eye"></i> </a>
                        @if ($blog->user_id == Auth::id() || Auth::user()->is_admin == 1)
                        &nbsp;&nbsp;
                        <a href="{{route('blog.edit',['id'=> $blog->id])}}"> <i class="fas fa-2x fa-edit"></i>  </a>&nbsp;&nbsp;
